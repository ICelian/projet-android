...
import fr.isen.lopez.androiderestaurant.network.User
import fr.isen.lopez.androiderestaurant.network.UserResult
...
class UserActivity : AppCompatActivity(), UserActivityFragmentInteraction {
    ...
    override fun makeRequest(
        ...
        if(verifyInformation(email,password,firstname,lastname,isFromLogin)){
            ...
            Toast.makeText( this, getString(R.string.invalidFomrs),Toast.LENGTH_LONG).show()
    ...
    companion object{
        const val USER_PREFERENCES_NAME = "USER_PREFERENCE_NAME"
